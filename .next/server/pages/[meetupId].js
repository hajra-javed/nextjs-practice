...
module.exports = __webpack_require__("jswi");
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* binding */ Details; });
...
// CONCATENATED MODULE: ./pages/[meetupId]/index.jsx
...
function Details({
  ...
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])(external_react_["Fragment"], {
    ...
    }), /*#__PURE__*/Object(jsx_runtime_["jsx"])(MeetupDetails, {
      title: details.title,
      image: details.image,
...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://hajra:abcd1234@cluster0.lnmb9at.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
